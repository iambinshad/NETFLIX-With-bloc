...
abstract class $FastlaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, bool isError, List<Downloads> videosList});
}
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'FastlaughState(isLoading: $isLoading, isError: $isError, videosList: $videosList)';
  }
...
abstract class _Initial implements FastlaughState {
  const factory _Initial(
      ...
      required final List<Downloads> videosList}) = _$_Initial;
